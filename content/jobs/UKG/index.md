...
- Develop and maintain critical Java Spring Boot services for the Time & Attendance (UTA) platform, integrating with UKG Pro and enterprise payroll systems to handle high transaction volumes across distributed environments
- Led a major Infor platform and Java 8 → JDK 17 upgrade across a large, business-critical UTA legacy codebase, including SQL Server migration from version 16 to 22, working directly with stakeholders to plan and optimize the migration
